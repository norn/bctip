from bctip.local_settings import *
...
ROOT_URLCONF = 'bctip.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bctip.wsgi.application'
...
WEBODT_TEMPLATE_PATH = '/mnt/reliable/repos/bctip/bctip/core/templates-odt'
OOFFICE_SERVER = ('127.0.0.1', 2002)

DEFAULT_FROM_EMAIL="noreply@bctip.org"
SERVER_EMAIL="noreply@bctip.org"
...
CELERY_RESULT_BACKEND = 'cache+memcached://10.0.3.11:11211/'
CELERY_IMPORTS=["core.tasks"]
CELERY_ACCEPT_CONTENT = ['json']
CELERY_TASK_SERIALIZER = 'json'
CELERY_RESULT_SERIALIZER = 'json'

#BROKER_URL = 'amqp://guest:guest@10.0.3.11:5672/'
